...
bash mksysroot
cd build
../gcc-12.1.0/configure CC="aarch64-linux-gnu-gcc-10" CXX="aarch64-linux-gnu-g++-10" --prefix=/data/data/com.termux/files/usr/gnu --enable-languages=c,c++ --disable-multilib --host=x86-64-linux-gnu --target=aarch64-linux-android --enable-default-pie --enable-shared --disable-bootstrap --with-arch=armv8-a --with-system-zlib
make -j8
